...
1. Identifique o tipo de serviço (refrigeração, máquina de lavar, marcenaria, reforma).
1. Pergunte o bairro e descrição do problema (peça foto se ajudar).
1. Informe o valor da visita do técnico para o bairro do cliente.
1. Agende para o dia mais próximo disponível (pode ser hoje).
1. Informe que o pagamento da visita é feito no ato.
1. Após a visita, o técnico passa o orçamento.
1. Repasse informações entre técnico e cliente fazendo a ponte.
1. Tente negociar com jogo de cintura se cliente questionar preço — não perca o serviço.
...
await fetch(`${SB}/rest/v1/intervencoes`, {
method: ‘POST’,
headers: {
apikey: KEY,
